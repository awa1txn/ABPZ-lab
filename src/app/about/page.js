...
export default function Home() {
  ...
  return (
    ...
    >
        ...
        <p>У рамках практичної роботи #2</p>
        <p>Логування дій користувачів у програмних системах.</p>
        <p>Засвоїти методику та отримати практичні навики розробки процедур логування дій користувачів на прикладі підсистем ідентифікації та аутентифікації користувачів із важкооборотними однонапрямленими хеш-функціями.</p>
    </h1>
    </section>
    </>
  )
